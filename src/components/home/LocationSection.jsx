...
import viewMap from "../../assets/viewmap.jpg";
        ...
        <div>
            <div className='bg-white p-4 mt-4 flex flex-col gap-3 relative border border-gray-200'>
                <div>
                    ...
                    <div className=' flex flex-col md:flex-row lg:flex-row gap-4 mt-4'>
                        <div className=' lg:w-[60%] w-[100%]'>
                            ...
                            <div onClick={handleOpenModel} className='cursor-pointer'>
                                <img className=' border  w-[100%] h-[300px] blur-[2px]' src={viewMap} alt="" />
                        ...
                        <div className=' lg:w-[40%] w-[100%]'>
                            ...
                            <div onClick={handleOpenModel} className='cursor-pointer'>
                                <img className=' w-[100%] h-[300px] blur-[2px]' src={map} alt="" />
                    ...
                    <div className=' mt-3'>
                        {datas.map((data, i) => (
                            <button onClick={() => handleOnChange(data.value, data.id)} className={`border p-2 border-yellow-600 `} key={i}>{data.label}</button>
                        ))}
